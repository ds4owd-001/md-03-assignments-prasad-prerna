...
3.  Why did we remove "safely managed sanitation services" from the data set in Task 3? - I think we are trying to focus on thh problem areas because of which we removed the safely managed sanitation services.
